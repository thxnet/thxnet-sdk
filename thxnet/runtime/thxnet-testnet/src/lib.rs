...
// Migration: remove ImOnline from session keys
...
pub mod migrations {
	...
	const UPGRADE_SESSION_KEYS_FROM_SPEC: u32 = 104_000_000;
	...
	/// v1.11.0 → v1.12.0: Staking v14 → v15.
