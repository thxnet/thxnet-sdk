...
use crate::chain_spec::{testnet::testnet_genesis_patch, ChainSpec, Extensions, ROOTCHAIN_TESTNET_NAME};
...
pub fn testnet_config() -> ChainSpec {
	...
	.with_name("Mirrored Body Test")
	.with_id("mirrored_body_testnet")
