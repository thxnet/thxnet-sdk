...
use sc_network::{service::traits::NetworkBackend, NetworkBlock, NotificationMetrics};
...
type TransactionPool = sc_transaction_pool::TransactionPoolHandle<Block, LeafchainClient>;
...
impl sc_executor::NativeExecutionDispatch for LeafchainNativeExecutor {
	...
	fn native_version() -> sc_executor::NativeVersion {
		general_runtime::native_version()
	}
}
...
> {
	...
	let executor = LeafchainExecutor::new_with_wasm_executor(wasm);
...
async fn start_node_impl<Net: NetworkBackend<Block, <Block as sp_runtime::traits::Block>::Hash>>(
	...
	let (rootchain_interface, collator_key, _relay_network, _req_receiver) =
...
pub async fn start_parachain_node<
	Net: NetworkBackend<Block, <Block as sp_runtime::traits::Block>::Hash>,
>(
	parachain_config: Configuration,
	polkadot_config: Configuration,
	collator_options: CollatorOptions,
	...
	start_node_impl::<Net>(parachain_config, polkadot_config, collator_options, para_id, hwbench)
		.await
}
