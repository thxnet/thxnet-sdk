...
impl SubstrateCli for Cli {
	...
	fn support_url() -> String {
		"https://github.com/thxnet/leafchains/issues/new".into()
	}
	...
	fn load_spec(&self, id: &str) -> std::result::Result<Box<dyn sc_service::ChainSpec>, String> {
		Ok(match id {
			...
			"leafchain-a-local" | "local-a" =>
				Box::new(chain_spec::local::leafchain_a_local_config()),
			"leafchain-b-local" | "local-b" =>
				Box::new(chain_spec::local::leafchain_b_local_config()),
...
impl SubstrateCli for RootchainCli {
	...
	fn support_url() -> String {
		"https://github.com/thxnet/rootchain/issues/new".into()
	}
		...
		None => {
			...
			runner.run_node_until_exit(|config| async move {
				...
				if matches!(
					...
					cumulus_client_cli::RelayChainMode::ExternalRpc(_)
				) && !cli.rootchain_args.is_empty()
				{
					tracing::warn!(
