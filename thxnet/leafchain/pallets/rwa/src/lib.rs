...
pub mod pallet {
    ...
    impl<T: Config> Pallet<T> {
            ...
            match currency {
                ...
                PaymentCurrency::Asset(asset_id) => {
                    <T::Fungibles as fungibles::Mutate<T::AccountId>>::transfer(
                        *asset_id, from, to, amount, frame_support::traits::tokens::Preservation::Preserve,
                    )?;
                }
            }
            Ok(())
        ...
        pub fn participations_by_holder(
            holder: T::AccountId,
        ...
        pub fn active_participant_count(asset_id: u32) -> u32 {
            RwaAssets::<T>::get(asset_id)
                .map(|a| a.participant_count)
                .unwrap_or(0)
        }
    }
}
