...
fn runtime_api_error(e: impl std::fmt::Debug) -> jsonrpsee::types::ErrorObjectOwned {
    jsonrpsee::types::ErrorObjectOwned::owned(-1, format!("Runtime API call failed: {:?}", e), None::<()>)
}
