...
pub trait LicenseVerifier<AccountId, BlockNumber> {
	...
	fn is_license_active(_rwa_asset_id: u32, _participation_id: u32) -> bool {
		true
	}
	...
	fn license_expiry(_rwa_asset_id: u32, _participation_id: u32) -> Option<BlockNumber> {
		None
	}
}
...
impl<AccountId, BlockNumber> LicenseVerifier<AccountId, BlockNumber> for () {
	fn ensure_active_license(_: u32, _: u32, _: &AccountId) -> DispatchResult {
		Ok(())
	}
}
...
pub enum FundingModel<Balance: Clone + PartialEq + Eq + core::fmt::Debug, MaxMilestones: Get<u32>> {
	#[codec(index = 0)]
...
pub struct CampaignConfig<
	...
	AssetId: Clone + PartialEq + Eq + core::fmt::Debug,
...
pub enum EligibilityRule<
	AssetId: Clone + PartialEq + Eq + core::fmt::Debug,
	Balance: Clone + PartialEq + Eq + core::fmt::Debug,
	CollectionId: Clone + PartialEq + Eq + core::fmt::Debug,
	ItemId: Clone + PartialEq + Eq + core::fmt::Debug,
	MaxNftSets: Get<u32>,
